...
/*
날짜 조작 함수
    MONTHS_BETWEEN(data1, data2) : 두 날짜 간의 월 수를 계산합니다.
    ADD_MONTHS(data, n) : 날짜를 n개월을 추가합니다.
    NEXT_DAYS(day_of_week) : 지정된 날짜의 다음으로 주어진 요일이 나오는 날짜를 계산합니다.
                            (1:일요일 ~ 7:토요일)
...
SELECT LAST_DAY(TO_DATE('2023-08-08', 'YYYY-MM-DD')) FROM dual;
...
/*
CASE 식
    IF_THEN_ELSE 문 작업을 수행하여 조건부 조회를 편리하게 수행하도록 합니다.
*/
