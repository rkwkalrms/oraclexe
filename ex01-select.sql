...
SQL (structured Query LAdnguage) - 구조적 질의 언어
...
열 alias 정의 - 별명
    ...
    공백이나 특수 문자를 포함하거나 대소문자를 구분하는 경우 큰 다옴표가 필요합니다.
*/
...
리터럴 문자열
    ...
    날짜 및 문자 리터럴 값은 작은 다옴표로 묶어야 합니다.
...
/* 
중복행
    기본적으로 Query 결과에는 중복행을 포함한 모든행이 표시됩니다.
